...
///
/// ```
/// use sbgn_validator::xml::Document;
/// use sbgn_validator::xpath::Documents;
///
...
///
/// ```
/// use sbgn_validator::xpath::Namespaces;
///
...
///
/// ```
/// use sbgn_validator::xpath::{Value, Variables};
///
