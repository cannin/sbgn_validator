...
<iso:schema    
  ...
  schemaVersion="0.2">
	...
	<iso:phase id="basic"> 
		<iso:active pattern="sbgn-namespace-0.3"/>
	...
	<iso:phase id="basic-allow-sbgnml-0.2">
		<iso:active pattern="00001"/>
		<iso:active pattern="00002"/>
		<iso:active pattern="er20001"/>
		<iso:active pattern="er10101"/>
	...
	<iso:pattern id="sbgn-namespace-0.3">
		<iso:rule context="/*">
			<iso:assert id="sbgn-namespace-0.3" role="error"
				test="namespace-uri() = 'http://sbgn.org/libsbgn/0.3'">SBGN namespace must be http://sbgn.org/libsbgn/0.3; found <iso:value-of select="namespace-uri()"/>.</iso:assert>
		</iso:rule>
	</iso:pattern>
